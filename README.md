...
Make sure your `robots.txt` allows Seobilitys bot to crawl the website or use my [Robots.txt plugin](https://github.com/bnomei/kirby3-robots-txt) which detects this automatically.
